...
<<<<<<< HEAD
      ...
      {
        id: 10, label: "Appointments", to: "/dashboard/patient-appointments", icon: RiCalendarLine },
      {
        id: 11, label: "Payments", to: "/dashboard/patient-payments", icon: RiCalendarLine },
=======
      {
        id: 10,
        label: "Appointments",
...
>>>>>>> ea763302ae43cde54ed240e6537ac84f91c59424
  ...
  },
  {
    ...
    links: [
<<<<<<< HEAD
      { id: 5, label: "Doctors", to: "/dashboard/doctors", icon: RiStethoscopeFill },
...
<<<<<<< HEAD
      { id: 9, label: "Setting", to: "/dashboard/settings", icon: RiSettingsLine },
=======
      {
        id: 9,
        label: "Setting",
